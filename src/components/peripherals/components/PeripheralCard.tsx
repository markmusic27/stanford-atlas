...
const PeripheralCard = ({ title }: PeripheralCardProps) => {
  return (
    <CursorScale hoverScale={1.01} maxTranslate={1}>
      <div className="bg-primary-6/[0.7] flex h-[30px] cursor-pointer flex-row items-center gap-[4px] rounded-[10px] pr-[8px] pl-[10px]">
        <Icon
          type={IconType.Slash}
          width={6}
          height={14}

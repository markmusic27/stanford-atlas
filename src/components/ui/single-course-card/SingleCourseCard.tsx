  ...
  return (
    <CursorScale hoverScale={1.003} maxTranslate={2}>
      <a
        ...
        className="block"
      >
        <div className="bg-primary-1 border-primary-7 flex h-[169px] w-full cursor-pointer flex-row items-stretch overflow-clip rounded-[24px] border-[1px] shadow-[0px_4px_10px_0px_rgba(0,0,0,0.03)]">
